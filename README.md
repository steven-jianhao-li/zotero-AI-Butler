...
4.  **沉浸阅读**：内置AI管家侧边栏，支持LaTeX公式渲染和大模型追问功能，一边读论文原文，一边看论文讲解，同时随时向大模型提问。还可以[固定侧边栏为AI管家](https://github.com/steven-jianhao-li/zotero-AI-Butler?tab=readme-ov-file#8-%E4%BE%A7%E8%BE%B9%E6%A0%8F-ai-%E7%AC%94%E8%AE%B0%E9%A2%84%E8%A7%88)，切换文献再也不会打断心流！
5.  **开源平台**：AI管家旨在提供一个自由、定制化的智能论文管理平台。所有模型提示词均可自定义——如何读文献，由您说了算；支持多个大模型的API——选择哪个大模型，也由您说了算。AI管家本身无任何收费渠道。
